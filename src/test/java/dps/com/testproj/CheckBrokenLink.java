...
public class CheckBrokenLink {
	...
	public void newBrokenCheckLink(String strBorkenURL) {
		...
		driver.get(strBorkenURL);
		List<WebElement> linkList = driver.findElements(By.tagName("a"));

		System.out.println("No of links present on website is :---> " + linkList.size());
		...
		try {
			...
			if (urlHttpConnection.getResponseCode() >= 400) {
				...
				System.out.println(brokenLink + "---> " + urlHttpConnection.getResponseMessage()
						+ urlHttpConnection.getResponseCode());
			}
		} catch (Exception e) {
	...
	public Object[][] getData() {
		return new Object[][] { { Objects.strURLForBrokenLinkPageCheck } };
	}
